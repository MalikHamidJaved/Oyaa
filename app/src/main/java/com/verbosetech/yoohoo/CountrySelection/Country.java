...
public class Country {
    ...
    public static List<Country> getLibraryMasterCountriesEnglish() {
        ...
        countries.add(new Country("bo", "591", "Bolivia, The Plurinational State Of Bolivia"));
        ...
        countries.add(new Country("cd", "243", "Congo, The Democratic Republic Of Congo"));
        ...
        countries.add(new Country("ir", "98", "Iran, The Islamic Republic Of Iran"));
...
//        countries.add(new Country("mk", "389", "Macedonia, The Former Yugoslav Republic Of"));
        countries.add(new Country("mk", "389", "Macedonia, The Republic Of Macedonia"));
        ...
        countries.add(new Country("fm", "691", "Micronesia, The Federal States Of Micronesia"));
        countries.add(new Country("md", "373", "Moldova, The Republic Of Moldova"));
        ...
        countries.add(new Country("tz", "255", "Tanzania, The United Republic Of Tanzania"));
        ...
        countries.add(new Country("ve", "58", "Venezuela, The Bolivarian Republic Of Venezuela"));
