...
public class Contact_Adapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHodler holder;
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.item_contact_number, parent, false);
...
//		}
		...
		if (!model.getContactNumber().equals("")
			...
			holder.phoneNumber.setText("CONTACT NUMBER - \n"
...
//		}
	...
	private class ViewHodler {
		...
		TextView contactName, phoneNumber, contactEmail, contactOtherDetails;
	}
}
