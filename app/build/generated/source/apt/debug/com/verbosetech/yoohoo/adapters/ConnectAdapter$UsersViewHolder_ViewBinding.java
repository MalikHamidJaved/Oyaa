...
public class ConnectAdapter$UsersViewHolder_ViewBinding implements Unbinder {
  private ConnectAdapter.UsersViewHolder target;

  @UiThread
  public ConnectAdapter$UsersViewHolder_ViewBinding(ConnectAdapter.UsersViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ConnectAdapter.UsersViewHolder target = this.target;
